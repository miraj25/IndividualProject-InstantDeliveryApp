package com.miraj25a.instantdelivery.Utils;
...
import com.miraj25a.instantdelivery.Common;
import com.miraj25a.instantdelivery.Model.TokenModel;
...
public class UserUtils {
    public static void updateUser(View view, Map<String, Object> updateData) {
        FirebaseDatabase.getInstance()
                ...
                .addOnSuccessListener(unused -> Snackbar.make(view,"Information successfully updated",Snackbar.LENGTH_SHORT).show());
    }
