...
import com.miraj25a.instantdelivery.Utils.UserUtils;
...
//                Toast.makeText(SplashScreenActivity.this, "Login layout should be shown now", Toast.LENGTH_SHORT).show();
                showLoginLayout();
        };
    }
...
//                                Toast.makeText(SplashScreenActivity.this, "show next", Toast.LENGTH_SHORT).show()
                );
    }
    @Override
